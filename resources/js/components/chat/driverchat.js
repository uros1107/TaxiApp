...
export default function Chat() {
    ...
    const passenger_communication = (passenger_id) => {
        $.ajax({
            url: "api/getpassenger",
    ...
    const list = (anchor) => (
        ...
        <List style={{paddingTop: 0}}>
            ...
            <ListItem button key={index}>
                <Button onClick={() => passenger_communication(passenger.id)}>
                    <ListItemIcon>
                        <Avatar alt="Remy Sharp" src={passenger.photo == null? "assets/images/users/default.png" : "assets/images/users/a" + passenger.photo}/>
                    </ListItemIcon>
    ...
    return (
        <div>
            ...
            <div style={avatarStyle}>
                ...
                <p style={{margin: "0px 15px", display: "inline", color: "#8c8c8c"}}>{touser.name}</p>
            </div>
